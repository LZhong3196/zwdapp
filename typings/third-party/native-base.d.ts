...
/** Romove the postfix - '@2.2.0' of the following line when replacing [node_modules/native-base/indes.d.ts] with this definition  */
declare module 'native-base@2.2.0' {
	namespace NativeBase {
		...
		interface Header {
			...
			iosBarStyle?: "light-content" | "dark-content";
