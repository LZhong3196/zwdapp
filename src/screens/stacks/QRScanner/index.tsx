...
import { Image, View, StatusBar, Animated, ActivityIndicator } from "react-native";
import {
    Button,
    Text,
    Container,
...
class QRScannerRectView extends React.PureComponent<any, any> {
    static defaultProps = {
        maskColor: "#0000004D",
        cornerColor: "#fff",
        borderColor: "#000000",
